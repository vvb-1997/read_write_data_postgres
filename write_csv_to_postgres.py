...
def create_postgres_table(table_name):
    ...
    """
    try:
        cur.execute(f"""CREATE TABLE IF NOT EXISTS {table_name} (RowNumber INTEGER PRIMARY KEY, CustomerId INTEGER, 
        ...
        logging.info(f' New table {table_name} created successfully to postgres server')
    except:
